	...
	return (
		<section id="tp-compilation" className='container'>
			...
			<article id='tp-compilation__description'>
				...
				<p>The following videos belongs to the author <a href='https://www.youtube.com/user/sononamida/' target='_blank' title='sononamida YouTube Channel' aria-label='sononamida YouTube Channel'>@sononamida</a>, so watch it directly from YouTube as appreciation.</p>
